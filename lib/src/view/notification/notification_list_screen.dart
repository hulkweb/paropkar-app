...
class NotificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    notificationController.getNotificationList(context);
    return Scaffold(
            ...
            children: [
              ...
              Consumer<NotificationController>(
                ...
                return DataStateWidget(
                  status: notificationController.notificationDataStatus,
                  ontapRetry: () {
                    notificationController.getNotificationList(context);
                  },
                  isDataEmpty: false,
                    ...
                    children: List.generate(
                      ...
                      return Padding(
                        ...
                        child: NotificationCard(
                          ...
                          isReaded: (notification?.read ?? 0) == 1,
                        ),
                      );
                    }),
                  ),
