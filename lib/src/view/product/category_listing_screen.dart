...
class CategoryListingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<CategoryListingController>(context).getCategories();
    return Scaffold(
        ...
        body:Consumer<CategoryListingController>(
          builder: (context,controller,state) {
            return DataStateWidget(
             ...
             isDataEmpty: controller.categoryData ==null || (controller.categoryData!.data == null) ||
              ...
              child: GridView.count(
                  ...
                  children: (controller.categoryData == null) || (controller.categoryData!.data == null) ||
                        (controller.categoryData!.data!.isEmpty)
                    ? [const SizedBox()]
                    : List.generate(
                    ...
                    (index)  {
                       final category =  controller.categoryData!.data![index];
                        return CategoryCard(
                          ...
                          onPressed: () {
                            context.read<ProductListingController>().getProducts();
