    ...
    return Scaffold(
      ...
      body: Consumer<AddressController>(
          builder: (context, addressController, child) {
            ...
            print( addressController.addressDataStatus,);
        ...
        return SizedBox(height: screenHeight,width: screenWidth,
          child: DataStateWidget(
            ...
            emptyDataWidget: Center(
              child: SizedBox(height: screenHeight*.1,width: screenWidth*.5,
                child: Center(
                  child: TextButton(child: Text( 'Add New Address',style: Theme.of(context).textTheme.bodyLarge,),onPressed: () {
                     addressController.clearAllControllers();
                    AppNavigation.navigationPush(context, CreateAddressScreen(screenType: 'create'));
                  },),
                ),
              ),
            ),
            ...
            isOverlay: (addressController.removeAddressStatus == OverlayStatus.loading)?true:false,
                ...
                children: isDataEmpty
                    ...
                    : List.generate(
                        ...
                        final address =
                            ...
                            print( addressController.addressListData!.data![index].isDefault);
                        return Padding(
                          ...
                          child: AddressCardSimple(
                            ...
                            ontapDelete: () {
                              addressController.removeAddressApi(context, addressId: address.id.toString());
                            },
                            isDefault:
                                 address.isDefault.toString() == '1' ? true : false,
                          ),
                        );
                      }),
              ),
