                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              controller.cartSummaryData == null ||
                                      controller.cartSummaryData!.data == null
                                  ? const SizedBox()
                                  : Container(
                                            ...
                                            children: [
                                              Text('Sub Total',
                                                  style: Theme.of(context)
                                                      ...
                                                      .bodyLarge),
                                              Text(
                                                  '₹ ${controller.cartSummaryData!.data!.subtotal}',
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .bodyLarge),
                                            ],
                                            ...
                                            children: [
                                              Text('Delivery Charges',
                                                  style: Theme.of(context)
                                                      ...
                                                      .bodyLarge),
                                              Text(
                                                  '₹ ${controller.cartSummaryData!.data!.tax}',
                                                  style: Theme.of(context)
                                                      .textTheme
                                                      .bodyLarge),
                                            ],
...
double convertToDouble(String input) {
  ...
  // If parsing is successful, return the result, otherwise return 0.0 or handle the error
  if (result != null) {
    return result;
  } else {
    print('Error: Cannot convert "$input" to a double.');
    return 0.0; // You can return any default value or handle it differently
  }
}